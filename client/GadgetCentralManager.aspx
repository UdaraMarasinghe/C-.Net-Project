<%@ Page Language="C#" Async="true" AutoEventWireup="true" CodeBehind="GadgetCentralManager.aspx.cs" Inherits="GadgetHub.Client.GadgetCentralManager" %>

<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Gadget Central Manager</title>
    <style>
        body {
...
<body>
    <form id="form1" runat="server">
        <div class="title">Gadget Central Manager</div>
        ...
        <script>
            document.querySelectorAll(".quote-button").forEach(button => {
                button.addEventListener("click", async function () {
                    ...
                    const estimatedTime = row.querySelector('.estimatedTime').value.trim();
                    ...
                    const payload = {
                        ...
                        Tquantity: null,
                        Equantity: null,
                        Gquantity: suppliedQty,
                        TestimatedTime: null,
                        EestimatedTime: null,
                        GestimatedTime: estimatedTime
                    };
