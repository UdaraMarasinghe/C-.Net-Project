<%@ Page Language="C#" Async="true" AutoEventWireup="true" CodeBehind="TechWorldManager.aspx.cs" Inherits="GadgetHub.Client.TechWorldManager" %>

<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Tech World Manager</title>
    <style>
        body {
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="title">TECH World Manager</div>
        ...
        document.querySelectorAll(".quote-button").forEach(button => {
            button.addEventListener("click", async function () {
                ...
                const payload = {
                    ...
                    Eprice: null,
                    Gprice: null,
                    Tquantity: suppliedQty,
                    Equantity: null,
                    Gquantity: null,
                    TestimatedTime: estimatedTime,
                    EestimatedTime: null,
                    GestimatedTime: null
                };
